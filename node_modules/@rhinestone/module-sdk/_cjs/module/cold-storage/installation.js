...
const getColdStorageHook = async ({ account, client, waitPeriod, owner, moduleType, hook, }) => {
    ...
    const initData = installedModules.includes(constants_1.COLD_STORAGE_HOOK_ADDRESS)
        ? '0x'
        : (0, viem_1.encodePacked)(['uint128', 'address'], [BigInt(waitPeriod), owner]);
    return {
        address: constants_1.COLD_STORAGE_HOOK_ADDRESS,
        module: constants_1.COLD_STORAGE_HOOK_ADDRESS,
        initData,
        deInitData: '0x',
...
const getAllowedCallbackSenders = ({ addresses, functionSig, callType, selector, hook, }) => {
    return {
        ...
        module: constants_1.COLD_STORAGE_FLASHLOAN_ADDRESS,
