...
export declare class Safe4337Pack extends RelayKitBasePack<{
     ...
     */
    constructor({ protocolKit, bundlerClient, bundlerUrl, chainId, paymasterOptions, entryPointAddress, safe4337ModuleAddress, safeWebAuthnSharedSignerAddress }: Safe4337Options);
    /**
